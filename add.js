...
if (!hasRequiredRole) {
  ...
  // If the user has the required role, continue with the existing code execution

  // ... (your existing code)
  let run_x = [];
  let booster1 = " ",booster2 = " ", booster3 = " ", booster4 = " ", booster5 = " ", booster6 = " ", booster7 = " ", booster8 = " ", booster9 = " ", booster10 = " ", booster11 = " ", booster12 = " ", booster13 = " ", booster14 = " ", booster15 = " ";
  let run_x1 = " ",run_x2 = " ", run_x3 = " ", run_x4 = " ", run_x5 = " ", run_x6 = " ", run_x7 = " ", run_x8 = " ", run_x9 = " ", run_x10 = " ", run_x11 = " ", run_x12 = " ", run_x13 = " ", run_x14 = " ", run_x15 = " ";
  let question = context.params.event.content.replace('!add', '').split('mplus')[0].trim()
  ...
  */
  ...
  if (context.params.event.content.split(' ')[4] != null) {
    booster1 = context.params.event.content.split(' ')[4]
    run_x[0] = context.params.event.content.split(' ')[5]
  }else booster1 = "";
  if (context.params.event.content.split(' ')[6] != null) {
    booster2 = context.params.event.content.split(' ')[6]
    run_x[1] = context.params.event.content.split(' ')[7]
  }else booster2 = ""
  if (context.params.event.content.split(' ')[8] != null) {
    booster3 = context.params.event.content.split(' ')[8]
    run_x[2] = context.params.event.content.split(' ')[9]
  }else booster3 = ""
  if (context.params.event.content.split(' ')[10] != null) {
    booster4 = context.params.event.content.split(' ')[10]
    run_x[3] = context.params.event.content.split(' ')[11]
  }else booster4 = ""
  if (context.params.event.content.split(' ')[12] != null) {
    booster5 = context.params.event.content.split(' ')[12]
    run_x[4] = context.params.event.content.split(' ')[13]
  }else booster5 = ""
  if (context.params.event.content.split(' ')[14] != null) {
    booster6 = context.params.event.content.split(' ')[14]
    run_x[5] = context.params.event.content.split(' ')[15]
  }else booster6 = ""
  if (context.params.event.content.split(' ')[16] != null) {
    booster7 = context.params.event.content.split(' ')[16]
    run_x[6] = context.params.event.content.split(' ')[17]
  }else booster7 = ""
  if (context.params.event.content.split(' ')[18] != null) {
    booster8 = context.params.event.content.split(' ')[18]
    run_x[7] = context.params.event.content.split(' ')[19]
  }else booster8 = ""
  if (context.params.event.content.split(' ')[20] != null) {
    booster9 = context.params.event.content.split(' ')[20]
    run_x[8] = context.params.event.content.split(' ')[21]
  }else booster9 = ""
  if (context.params.event.content.split(' ')[22] != null) {
    booster10 = context.params.event.content.split(' ')[22]
    run_x[9] = context.params.event.content.split(' ')[23]
  }else booster10 = ""
  if (context.params.event.content.split(' ')[24] != null) {
    booster11 = context.params.event.content.split(' ')[24]
    run_x[10] = context.params.event.content.split(' ')[25]
  }else booster11 = ""
  if (context.params.event.content.split(' ')[26] != null) {
    booster12 = context.params.event.content.split(' ')[26]
    run_x[11] = context.params.event.content.split(' ')[27]
  }else booster12 = ""
  if (context.params.event.content.split(' ')[28] != null) {
    booster13 = context.params.event.content.split(' ')[28]
    run_x[12] = context.params.event.content.split(' ')[29]
  }else booster13 = ""
  if (context.params.event.content.split(' ')[30] != null) {
    booster14 = context.params.event.content.split(' ')[30]
    run_x[13] = context.params.event.content.split(' ')[31]
  }else booster14 = ""
  if (context.params.event.content.split(' ')[32] != null) {
    booster15 = context.params.event.content.split(' ')[32]
    run_x[14] = context.params.event.content.split(' ')[33]
  }else booster15 = ""
  ...
  for (let i = 0; i < memberIds.length; i++) {
    results.push(await boosters(run_x[i], total_booster_cut));
  }
  //console.log(memberIds[1]);
  // Use the Google Sheets API to search for rows containing the member IDs in your sheet
  let spreadsheetId = '1ITxpnzHGL9sL5sgYhhQSDd4Q1m-rd6U7zoa4sF9yYoU'; // Replace with your actual spreadsheet ID
  //let sheetName = 'Sheet4'; // Replace with your actual sheet name
  let range = 'Sheet4!A:C'; // Adjust the range as needed
  Promise.all(results);
  // Update the cut field for each row found with the new cut value using the Google Sheets API
  if (!timeout) {
   for (let i = 0; i < memberIds.length; i +=1) {
    ...
    let new_cut_value = parseInt(current_cut_value) + parseInt(results[i]);
  ...
  await lib.discord.channels['@0.3.0'].messages.create({
    channel_id: context.params.event.channel_id,
    content: `:key: Your Mythic+ Payment Done! Thank you :key:`
  });
}
